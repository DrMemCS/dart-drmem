...
void main() {
  test("... Reading", () {
    ...
    expect(
      () => Reading.fromParams(ts, null, null, null, null, null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, true, 1, null, null, null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, true, null, 1.0, null, null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, true, null, null, "abc", null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, true, null, null, null, [1, 2, 3]),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, 1, 1.0, null, null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, 1, null, "abc", null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, 1, null, null, [1, 2, 3]),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, null, 1.0, "abc", null),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, null, 1.0, null, [1, 2, 3]),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, null, null, "abc", [1, 2, 3]),
      throwsA(isArgumentError),
    );
    expect(
      () => Reading.fromParams(ts, null, null, null, "abc", [1, 2]),
      throwsA(isArgumentError),
    );
    expect(
