...
void main() {
  ...
  test("... Device comparisons", () {
    ...
    expect(
      Device(name: "a", node: "z").compareTo(Device(name: "a", node: "z")),
      equals(0),
    );
    expect(
      Device(name: "a", node: "y").compareTo(Device(name: "a", node: "z")),
      equals(-1),
    );
    expect(
      Device(name: "a", node: "z").compareTo(Device(name: "a", node: "y")),
      equals(1),
    );
    ...
    expect(
      Device(name: "b", node: "z").compareTo(Device(name: "a", node: "z")),
      equals(1),
    );
    expect(
      Device(name: "b", node: "y").compareTo(Device(name: "a", node: "z")),
      equals(1),
    );
    expect(
      Device(name: "b", node: "z").compareTo(Device(name: "a", node: "y")),
      equals(1),
    );

    expect(
      Device(name: "a", node: "z").compareTo(Device(name: "b", node: "z")),
      equals(-1),
    );
    expect(
      Device(name: "a", node: "y").compareTo(Device(name: "b", node: "z")),
      equals(-1),
    );
    expect(
      Device(name: "a", node: "z").compareTo(Device(name: "b", node: "y")),
      equals(-1),
    );
  });
}
