  ...
  Reading.fromParams(
    ...
    List<int>? c,
      ...
      value = switch ((b, i, d, s, c)) {
        ...
        (null, null, null, null, [int r, int g, int b]) => DevColor(
          red: r,
          green: g,
          blue: b,
        ),
        (null, null, null, null, [int r, int g, int b, int a]) => DevColor(
          red: r,
          green: g,
          blue: b,
          alpha: a,
        ),
        (null, null, null, null, _) when c != null => throw (ArgumentError(
          "wrong number of color components",
          "c",
        )),
        (null, null, null, null, null) => throw (ArgumentError(
          "reading has no data",
        )),
