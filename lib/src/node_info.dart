...
class NodeInfo {
  ...
  /// of signatures; the first is an MD5 hash and the second is an SHA-256
  /// hash. If this field is `null`, then the DrMem node uses an unencrypted
  /// socket. If it is not `null`, a TLS socket should be used (i.e. https).
  ...
  static NodeInfo? fromJson(Map<String, dynamic> json) {
    ...
    dev.log(
      "couldn't restore node info for $json ... dropping from list",
